...
export const CreateView: React.FC<CreateViewProps> = ({
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-950 via-gray-900 to-black p-4 flex items-center justify-center">
      <div className="bg-gray-800/80 backdrop-blur-lg rounded-2xl border border-gray-700/50 p-3 w-full max-w-[360px] shadow-2xl mx-auto flex flex-col">
        {/* Shape Toolbar */}
        <ShapeToolbar
        ...
        <div className="flex-shrink-0 space-y-2">
          ...
          <div className="flex gap-1">
            <button
              ...
              className="flex-1 py-1 bg-gray-700 text-gray-300 rounded text-xs border border-gray-600"
            >
              Clear
            </button>
            <button
              onClick={onSaveChallenge}
              className="flex-1 py-1 bg-white text-black rounded text-xs font-medium"
            >
              Save
            </button>
          </div>
          ...
          <button
            ...
            className="w-full py-1 bg-gray-700 text-gray-300 rounded text-xs border border-gray-600"
          >
            ← Back
          </button>
        </div>
